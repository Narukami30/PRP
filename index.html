...
<html lang="en">
  <head>
    ...
    <title>Code Help Portfolio Website</title>
    <link rel="stylesheet" href="./styles.css" />
    <script
      src="https://kit.fontawesome.com/fb22eebb87.js"
  ...
  <body>
    <div id="wrapper">
      <div class="container">
        <nav class="nav-section">
          <div class="nav-name">
            <img
              class="nav-name-logo"
              src="./images/userAsset/logo-removebg-preview.png"
              alt="nav-name"
            />
            <span>ark Gabriel Baje</span>
          </div>
          <div class="nav-items">
        ...
        <header class="header-container">
          <section class="left">
            <!-- <div class="title-name-work"> -->
            <div class="left-text-para">
              <p>Hi! Mark Gabriel Baje</p>
              <p>I am a <span class="role"></span></p>
              <p>
            ...
            <div class="faded-name">
              <span>Mark Gabriel Baje</span>
            </div>
            <!-- </div> -->
          </section>
          <section class="right">
            <div class="user-img">
              <img src="./images/userAsset/userphoto.jpg" alt="" />1
            </div>
            <div class="zig-zag-img">
            ...
            <div class="skills-img-text">
              <div class="flex">
                <div class="skills-img">
                  <img class="img" src="./images/stack/HTML.png" alt="" />
                  <img class="img" src="./images/stack/Javascript.svg" alt="" />
                  <img class="img" src="./images/stack/Express.png" alt="" />
                  <img
                    class="img"
                    src="./images/stack/NextJsCircle.png"
                    alt=""
                  />
                  <img class="img" src="./images/stack/Tailwind.png" alt="" />
                  <img class="img" src="./images/stack/NodeJs.svg" alt="" />
                  <img class="img" src="./images/stack/MongoDB.svg" alt="" />
                  <img class="img" src="./images/stack/Typescript.svg" alt="" />
                  <img class="img" src="./images/stack/Bootstrap.svg" alt="" />
                  <img class="img" src="./images/stack/HTML.png" alt="" />
                </div>
                <div class="car-text">
                  ...
                  <div class="button-container">
                    ...
                    <img src="./images/stack/Github.svg" alt="" />
                    <img src="./images/stack/Git.svg" alt="" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="project-04 projects-01 project">
            ...
            <div class="flex flex-move-right">
              <div class="skills-img">
                ...
                <img class="img" src="./images/stack/Javascript.svg" alt="" />
                <img class="img" src="./images/stack/Express.png" alt="" />
                <img class="img" src="./images/stack/NextJsCircle.png" alt="" />
                <img class="img" src="./images/stack/Tailwind.png" alt="" />
                <img class="img" src="./images/stack/NodeJs.svg" alt="" />
                <img class="img" src="./images/stack/MongoDB.svg" alt="" />
                <img class="img" src="./images/stack/Typescript.svg" alt="" />
      ...
      <div id="skills" class="skills-container">
        <div class="skills-wrapper">
          <div class="skills-text left">
            ...
            <p class="skills-para">
              Hi Everyone My name is Mark Gabriel Baje I am a Full Stack Web Developer I
              have been working for last 3 Years and Currently I am working with
              a Budding Startup in Philippines and a full Time Freelancer. Currently I
              ...
              <br />
              <br />
              Does it not cause pain, but rather, greater pleasures with fewer praises? 
              We pursue minimal pain, but great pleasure, and those who follow no discomfort at all.
              <br />
              <br />
              Who indeed are those who obtain truth? Pleasures 
              are taken by those who follow nothing but fault.
            </p>
          </div>
          ...
          <div class="skills-skills-img">
            ...
            <div class="skills-languages-logo">
              ...
              <img
                class="skills-language-logo"
                src="./images/stack/K8s.svg"
                alt=""
              />
              <img
                class="skills-language-logo"
                src="./images/stack/MaterialUI.svg"
                alt=""
              />
              <img
                class="skills-language-logo"
      ...
      <footer class="footer-section">
        <span class="profile-name">Mark Gabriel Baje</span>
